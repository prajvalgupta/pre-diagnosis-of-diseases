...
with open('primary_pivoted2 (classified)1.csv') as csvfile:
...
dataframe = pd.read_csv("test_primary.csv", header=None)
...
def primary(p1):    
    ...
    if len(df_)>0:
        ...
        return printf('Disease after primary classification: ', dtc.predict(test))
'''
